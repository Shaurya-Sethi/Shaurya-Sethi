...
- 🌱 I’m exploring: Model Context Protocol 
- 💡 Favorite tech: Python, PyTorch, R, Transformers
- ⚡ Fun fact: I enjoy building things from scratch

## 🌐 Socials:
[![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:shauryaswapansethi@gmail.com) 
...
## 🏆 Achievements
- 📦 Released [Transqlate](https://pypi.org/project/transqlate/): a production-ready, schema-aware NL→SQL assistant (PyPI package) powered by a fine-tuned LLM, supporting interactive querying across SQLite, PostgreSQL, MySQL, MSSQL, and Oracle
- 🤖 Building [Circuitron](https://github.com/Shaurya-Sethi/circuitron): an agentic PCB design accelerator that automates schematic generation from natural language prompts
